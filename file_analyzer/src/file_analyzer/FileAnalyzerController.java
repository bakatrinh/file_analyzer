...
public class FileAnalyzerController {
	...
	public void openFile(JFileChooser fileChooser) {
		...
		// Anthony, add code to use _file, convert to binary string, then output into text area here
		// use _view.getTextArea() to select it, then set text, etc., you can open any type of file to test
